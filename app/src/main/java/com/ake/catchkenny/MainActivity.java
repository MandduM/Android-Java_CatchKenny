...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CountDownTimer(10000,1000){
            ...
            public void onFinish() {
                ...
                alert.setMessage("How About Starting Over ?");
                ...
                alert.setNegativeButton("NO", (dialogInterface, i) -> Toast.makeText(MainActivity.this,"GAME OVER",Toast.LENGTH_LONG));
    ...
    public void Score(View view){
        ...
        scoree++;
        scoreText.setText("Score : "+scoree);
    }
